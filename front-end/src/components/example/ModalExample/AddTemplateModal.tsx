...
export default function AddTemplateModal({ onTemplateAdded }: AddTemplateModalProps) {
  ...
  const projectOptions = [
    { value: "1", label: "Projet A" },
    { value: "2", label: "Projet B" },
  ];
  ...
  const handleSelectChange = (selectedValue: string) => {
    setFormData((prev) => ({
      ...prev,
      assignedProjects: [selectedValue], // or just selectedValue if not an array
    }));
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
            ...
            <div className="md:col-span-2">
              ...
              <Select
                ...
                placeholder="Sélectionner le nom du projet"
