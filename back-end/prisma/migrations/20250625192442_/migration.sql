...
-- CreateEnum
CREATE TYPE "PriceType" AS ENUM ('FIXE', 'M2');

-- CreateEnum
CREATE TYPE "ProjectStatus" AS ENUM ('PLANIFICATION', 'CONSTRUCTION', 'DONE');
...
CREATE TABLE "Project" (
    ...
    "folderFees" DOUBLE PRECISION,
    "commissionPerM2" DOUBLE PRECISION,
    "totalSales" DOUBLE PRECISION,
    "status" "ProjectStatus" NOT NULL DEFAULT 'PLANIFICATION',
    "progress" INTEGER NOT NULL DEFAULT 0,
    "constructionPhotos" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
